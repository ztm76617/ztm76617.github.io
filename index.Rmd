...
trestles_mod <- gsub('style="height:35rem"', 'style="width: 65%; max-width: 280px"', trestles_mod)
...
The [Readings](readings.html) page collects articles and books that have most shaped my thinking. Feel free to reach out by email with any questions.
